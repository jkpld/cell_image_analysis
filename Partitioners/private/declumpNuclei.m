...
% DECLUMPNUCLEI Find the nuclei centers in a binary image of nuclei and
% then partition the nuclei clumps using geometric partitioning.
%
...
function [cuts, seedPoints, Info] = processObject(pixList, nRows, r0set, useCentroid, B, N, K, I, S, obj, salr_options, geoPart_options)
    ...
    % Compute seed points
    [seedPoints, salr_Info] = computeObjectSeedPoints(objBW, salr_options, 'r0set', r0set, 'useCentroid', useCentroid, 'objNumber', obj);
